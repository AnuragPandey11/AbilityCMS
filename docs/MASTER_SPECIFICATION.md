...
**Version:** 2.3 · **Date:** 12 September 2026 · **Status:** Living document
...
| §7 | Dashboard set (Portfolio / Overview / List / Single Plant / SLD) | Partial — data model supports it; frontend unbuilt |
...
| **OPEN-16** | The client's exact formulas for PR, CUF, Availability | Tender §18; whether our figures reconcile with the client's existing reports | **Client has undertaken to answer.** Variants differ by percentage points; a mismatch will be reported as a system defect |
